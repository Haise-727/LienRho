...
| **Track 3: Voice AI & Agents** | ElevenLabs/Agentic Framework | CFO Voice Cockpit, Call Simulator, Market Clearing Agents |
...
## All sponsor integrations (ElevenLabs, Stitch, CodeCrafters, Agentic Framework) ARE in this MVP phase.

Per your call: AWS/cloud infra and the three sponsor integrations (voice
verification, the Rust/Go clearing engine, Agentic Framework) are **not** part of getting
